...
# do nath to calculate when chatbot wiil be 100
myage = int(myage)
nyears = 100 -myage
print(f'I will be 100 in {nyears} years')
print(f'That will be the year {year} {nyears}')

# food conversation
print('I iove chocolate and I also like trying our new kinds of food')
food = input('How about? What is your favorite food?:\n')
